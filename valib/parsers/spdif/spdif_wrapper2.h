#ifndef SPDIF_WRAPPER2_H
#define SPDIF_WRAPPER2_H
...
class SpdifWrapper2 : public SimpleFilter
{
public:
  int dts_mode;
  int dts_conv;
  SpdifWrapper2(int dts_mode = DTS_MODE_AUTO, int dts_conv = DTS_CONV_NONE);
